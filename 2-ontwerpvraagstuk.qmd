...
Backwards design is een ontwerpmethode waarbij het ontwerpen van het onderwijs begint bij het einde, namelijk de beoogde leeropbrengsten. Vanuit daar wordt terug geredeneerd naar hoe je deze beoogde leeropbrengsten het best kunt beoordelen, wat hierbij passende datapunten zijn, wat goede leeractiviteiten zijn en welke materialen en mensen je hiervoor nodig hebt (bron vernieuwende wijs). Het toepassen van backwards design als ontwerpmethode kan op verschillende niveaus. Zo kan het betrekking hebben op een enkele les of een onderwijsperiode, maar zeker ook op het ontwerpen van programmatisch toetsen. Hieronder wordt kort omschreven hoe backwards design eruit ziet voor het ontwerpen van de datapunten bij programmatisch toetsen (Biemond en Baartman, 2021). Lees voor meer gedetailleerde informatie  het volledige artikel (Backward design bij programmatisch toetsen: Professioneel begeleiden) of bekijk het [filmpje](https://hva.mediamission.nl/Mediasite/MyMediasite/presentations/b8f23800ce264f93809f1015c7ff02dd1d).
